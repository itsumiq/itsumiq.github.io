...
export const TodosList = () => {
  ...
  return (
    <ul className="theme-animation mt-[2.25rem] grid h-[24.375rem] w-full auto-rows-[4rem] gap-y-px overflow-scroll rounded-t bg-milk max-phone:mt-0 max-phone:h-[35.714rem] max-phone:rounded dark:bg-black-secondary">
        ...
        <li key={id}>
          <div className="group flex h-full items-center justify-between px-7">
            ...
            <DeleteTodo
              ...
              variant="group-hover:opacity-100 opacity-0 transition-all duration-700 max-lg:opacity-100"
            >
              <X size="1.813rem" />
            </DeleteTodo>
          </div>
